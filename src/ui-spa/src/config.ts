...
export const PRIVATE_BETA_USER_GROUP = import.meta.env
  .VITE_PRIVATE_BETA_USER_GROUP;
export const PRIVATE_BETA_CONTACT_EMAIL = import.meta.env
  .VITE_PRIVATE_BETA_CONTACT_EMAIL;
