...
public class ListMonitoringCodesTests
{
    ...
    public ListMonitoringCodesTests()
    {
        ...
        _function = new ListMonitoringCodes(_loggerMock.Object, _mdsClientMock.Object, _mdsArgFactoryMock.Object);
    }
    ...
    {
        // Arrange
        var expectedMonitoringCodes = _fixture.Create<MonitoringCodeEntity[]>();
        ...
        _mdsClientMock.Verify(c => c.GetMonitoringCodesAsync(baseArg), Times.Once);
    }
}