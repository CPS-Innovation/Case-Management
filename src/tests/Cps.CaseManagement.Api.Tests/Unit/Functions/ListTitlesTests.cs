...
public class ListTitlesTests
{
    ...
    public ListTitlesTests()
    {
        ...
        _function = new ListTitles(_loggerMock.Object, _mdsClientMock.Object, _mdsArgFactoryMock.Object);
    }

    [Fact]
    public async Task Run_ReturnsOkObjectResult_WithExpectedTitles()
    {
        // Arrange
        var expectedTitles = _fixture.Create<TitleEntity[]>();
        ...
        _mdsClientMock
            .Setup(c => c.GetTitlesAsync(baseArg))
        ...
        _mdsClientMock.Verify(c => c.GetTitlesAsync(baseArg), Times.Once);
    }
}
