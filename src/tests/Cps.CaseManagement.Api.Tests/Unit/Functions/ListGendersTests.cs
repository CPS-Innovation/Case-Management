...
{
    private readonly Mock<ILogger<ListGenders>> _loggerMock;
    ...
    {
        _loggerMock = new Mock<ILogger<ListGenders>>();
        _mdsClientMock = new Mock<IMdsClient>();
        _mdsArgFactoryMock = new Mock<IMdsArgFactory>();
        _fixture = new Fixture();
        _function = new ListGenders(_loggerMock.Object, _mdsClientMock.Object, _mdsArgFactoryMock.Object);
    }
    ...
    {
        // Arrange
        var expectedGenders = _fixture.Create<GenderEntity[]>();
        ...
        _mdsClientMock.Verify(c => c.GetGendersAsync(baseArg), Times.Once);
    }
}