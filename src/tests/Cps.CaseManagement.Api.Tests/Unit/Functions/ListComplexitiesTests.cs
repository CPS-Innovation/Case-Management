...
{
    private readonly Mock<ILogger<ListComplexities>> _loggerMock;
    ...
    {
        _loggerMock = new Mock<ILogger<ListComplexities>>();
        _mdsClientMock = new Mock<IMdsClient>();
        _mdsArgFactoryMock = new Mock<IMdsArgFactory>();
        _fixture = new Fixture();
        _function = new ListComplexities(_loggerMock.Object, _mdsClientMock.Object, _mdsArgFactoryMock.Object);
    }
    ...
    {
        // Arrange
        var expectedComplexities = _fixture.Create<ComplexitityEntity[]>();
        ...
        _mdsClientMock.Verify(c => c.GetComplexityCodesAsync(baseArg), Times.Once);
    }
}
